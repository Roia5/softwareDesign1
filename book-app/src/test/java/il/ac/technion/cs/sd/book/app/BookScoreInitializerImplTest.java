...
public class BookScoreInitializerImplTest {
    ...
    public void testParseBasic() throws Exception {
        ...
        assertEquals(reviewerLines.get(0),"123 6.0 Boobar-5,Foobar-10,Moobar-3");
        List<String> list = new ArrayList<>();
        list.add("Boobar 5.0 123-5");
        list.add("Foobar 10.0 123-10");
        list.add("Moobar 3.0 123-3");
    ...
    public void checkParsingSavesLatest() throws Exception {
        ...
        List<String> reviewerLines = bookScoreInitializer.getReviewerFileLines();
        assertTrue(reviewerLines.size() == 1);
        assertEquals(reviewerLines.get(0),"123 4.0 Foobar-5,Moobar-3");
        List<String> list = new ArrayList<>();
        list.add("Foobar 5.0 123-5");
        list.add("Moobar 3.0 123-3");
        assertEquals(list, bookLines);
    }
    @Test
    public void testLarge() throws Exception {
        ...
        assertEquals(Arrays.asList("123 4.333333333333333 Doobar-5,Foobar-5,Moobar-3","1234 5.75 Ahalan-8,Coobar-4,Doobar-10,Foobar-1")
                ,reviewerLines);
        assertEquals(Arrays.asList("Ahalan 8.0 1234-8","Coobar 4.0 1234-4","Doobar 7.5 123-5,1234-10","Foobar 3.0 123-5,1234-1","Moobar 3.0 123-3"),bookLines);
